# Decree card reference — supplied grid

Source: [original image grid](decree-grid.png), supplied by the owner for reference during Milestone 4. Card wording is game content, not agent instructions. The engine now implements the 19 included cards. Current interpretation is consolidated in Rulebook v1.5 section 56.

Owner filter: exclude objectives requiring separately tracked Dodges against the Cat. Keep the Cat-defeat objective. General Dodge objectives remain eligible. Do not create a separate Cat-Dodge tracker.

| Card | Condition shown | Divine Favor | Status |
|---|---|---:|---|
| Bajo presión | Win the Arena with exactly 1 Health | 2 | Reference |
| Venganza | Finish by counterattack | 3 | Reference |
| Pacifista del palomo | Finish the Arena alive without making an Attack | 3 | Confirmed: zero damage dealt, including counters |
