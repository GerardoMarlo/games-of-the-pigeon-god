...
export const decreeCards:readonly DecreeCard[]=[
 ...
 {id:'pacifista',name:'Pigeon Pacifist',reward:3,timing:'end_of_arena',condition:{kind:'pacifist'}},
 ...
 {id:'cuchillas',name:'Dancing Between Blades',reward:1,timing:'immediate',condition:{kind:'threshold',stat:'dodges',value:3}},
];
