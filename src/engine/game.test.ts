...
function fixture():GameState {const s=createGame({seed:12345,playerCount:2});s.phase='PLAYER_ACTION';s.activePlayerId='p1';s.players.p1.actionsRemaining=2;return s;}
