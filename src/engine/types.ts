...
export interface BoardState { hexes:Record<string,HexState>; spawns:HexCoordinate[]; catSpawn:HexCoordinate; burrows?:{position:HexCoordinate;entry:HexCoordinate}[] }
